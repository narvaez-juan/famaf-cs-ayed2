...
int main(int argc, char *argv[]) {
    ...
    /* Show players points */
    unsigned int points1 = get_points(battleship_board, player1, max_round);
    unsigned int points2 = get_points(battleship_board, player2, max_round);
    printf("player_1 points: %u\n", points1);
    printf("player_2 points: %u\n", points2);
